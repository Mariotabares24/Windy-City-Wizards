...
const cosmoRows: CosmoRow[] = [
  { id: 'c-f01', kind: 'wrap dress', name: 'Linen Wrap Dress', category: 'fashion', price: 145, color: 'Blue', colors: ['Blue', 'Sage', 'Blush', 'Ivory'], material: 'European linen', description: 'An easy wrap silhouette in breathable linen, cut for warm-weather celebrations.', tags: ['dress', 'blue', 'wedding', 'summer', 'wrap', 'brunch'], stock: 24, formality: 'semi-formal', model: 'garment', ar: true, image: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=600' },
  { id: 'c-f02', kind: 'midi dress', name: 'Sapphire Midi Dress', category: 'fashion', price: 218, color: 'Cobalt', colors: ['Cobalt', 'Navy', 'Midnight'], material: 'Italian crepe', description: 'A structured bodice and midi length for evenings that call for a sharper line.', tags: ['dress', 'blue', 'cobalt', 'navy', 'wedding', 'cocktail'], stock: 12, formality: 'formal', model: 'garment', ar: true, image: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=600' },
  { id: 'c-f03', kind: 'slip dress', name: 'Cobalt Silk Slip Dress', category: 'fashion', price: 89, color: 'Cobalt', colors: ['Cobalt', 'Blue', 'Dusty blue'], material: 'Silk satin', description: 'Bias-cut silk that moves easily, dressed up or down by what you layer over it.', tags: ['dress', 'blue', 'cobalt', 'date', 'brunch', 'silk'], stock: 18, formality: 'casual', model: 'garment', ar: true, image: 'https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?w=600' },
  { id: 'c-f04', kind: 'blazer dress', name: 'Navy Blazer Dress', category: 'fashion', price: 195, color: 'Navy', colors: ['Navy', 'Blue', 'French blue'], material: 'Italian wool blend', description: 'A button-front blazer dress with a belt, tailored for the office and after.', tags: ['dress', 'blue', 'navy', 'office', 'structured', 'work'], stock: 9, formality: 'formal', model: 'garment', ar: true, image: 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=600' },
  { id: 'c-f05', kind: 'maxi dress', name: 'Powder Blue Maxi Dress', category: 'fashion', price: 79, color: 'Powder blue', colors: ['Powder blue', 'Sky blue', 'Blue'], material: 'Cotton voile', description: 'A soft, full-length cotton dress made for slow, hot afternoons.', tags: ['dress', 'blue', 'casual', 'vacation', 'summer', 'maxi'], stock: 0, formality: 'casual', model: 'garment', ar: true, image: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=600' },
  { id: 'c-f06', kind: 'tailored blazer', name: 'Tailored Blazer', category: 'fashion', price: 210, color: 'Black', colors: ['Black', 'Camel', 'Navy'], material: 'Wool blend', description: 'A clean-shouldered blazer that anchors both suiting and denim.', tags: ['blazer', 'jacket', 'office', 'cocktail', 'structured', 'work'], stock: 15, formality: 'formal', model: 'garment', ar: true, image: 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=600' },
  { id: 'c-f07', kind: 'midi skirt', name: 'Silk Midi Skirt', category: 'fashion', price: 89, color: 'Burgundy', colors: ['Burgundy', 'Gold', 'Dusty rose'], material: 'Silk', description: 'A fluid midi skirt with enough weight to hold its shape as you move.', tags: ['skirt', 'date', 'brunch', 'elegant', 'midi', 'silk'], stock: 22, formality: 'semi-formal', model: 'garment', ar: true, image: 'https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?w=600' },
  { id: 'c-f08', kind: 'knitwear', name: 'Cashmere Crew Neck', category: 'fashion', price: 175, color: 'Camel', colors: ['Camel', 'Ivory', 'Stone', 'Midnight'], material: 'Cashmere', description: 'A everyday crew neck in cashmere, warm without the bulk.', tags: ['knitwear', 'sweater', 'jumper', 'casual', 'office', 'autumn'], stock: 31, formality: 'casual', model: 'garment', ar: true, image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=600' },
